...
exports.AddCourseCategories1778700000000 = void 0;
class AddCourseCategories1778700000000 {
    ...
    async down(queryRunner) {
        try {
            await queryRunner.query(`ALTER TABLE \`courses\` DROP FOREIGN KEY \`FK_courses_category\``);
        }
        catch (_) { }
        try {
...
exports.AddCourseCategories1778700000000 = AddCourseCategories1778700000000;
